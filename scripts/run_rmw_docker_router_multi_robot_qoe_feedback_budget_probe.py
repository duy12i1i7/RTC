"""Run subscriber-QoE-driven redundancy allocation with active ROS 2 publishers."""
...
SCHEMA_VERSION = "fleetrmw.rmw_router_multi_robot_qoe_feedback_budget_probe.v1"
...
def main() -> int:
    ...
    parser.add_argument("--topic-prefix", default=f"{DEFAULT_TOPIC_PREFIX}_qoe_feedback")
    ...
    parser.add_argument(
        ...
        default=(
            "results_rmw_socket/"
            "docker_router_multi_robot_qoe_feedback_budget_probe_summary.json"
        ),
    )
    ...
    if args.json:
        ...
        print("fleetrmw-router-multi-robot-qoe-feedback-budget-probe")
