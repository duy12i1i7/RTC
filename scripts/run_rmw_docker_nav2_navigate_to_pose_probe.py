...
def run_probe(
    *,
    ...
    build_base = root / ".tmp_fleetrmw_nav2_ntp_build"
    install_base = root / ".tmp_fleetrmw_nav2_ntp_install"
    log_base = root / ".tmp_fleetrmw_nav2_ntp_log"
    ...
    router_exe = (
        "/work/.tmp_fleetrmw_nav2_ntp_install/rmw_fleetqox_cpp/lib/"
