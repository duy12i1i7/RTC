...
def run_probe(*, root: Path, image: str, port_base: int) -> dict[str, Any]:
    ...
    build_base = root / ".tmp_fleetrmw_nav2_cp_build"
    install_base = root / ".tmp_fleetrmw_nav2_cp_install"
    log_base = root / ".tmp_fleetrmw_nav2_cp_log"
    ...
    router_exe = (
        "/work/.tmp_fleetrmw_nav2_cp_install/rmw_fleetqox_cpp/lib/"
