# Sidecar Lagrangian Outcome Adaptation Netem V1
...
- Non-dominated policies: `fleetqox_predictive`, `fleetqox_csds`, `lag_012`, `fleetqox_predictive_guarded`, `lag_adapt_001`.
...
- Dominated policies in the current evidence set: `lag_015`.
