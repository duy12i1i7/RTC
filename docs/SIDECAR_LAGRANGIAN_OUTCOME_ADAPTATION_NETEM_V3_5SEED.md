# Sidecar Lagrangian Outcome Adaptation Netem V3 5-Seed
...
| `lag_adapt_003` | 5 | yes | 6899.2 +/- 313.3 | 0.0000 +/- 0.0000 | 0.0000 +/- 0.0000 | 0.0100 +/- 0.0020 | 27.29 +/- 0.1507 | 1172.0 +/- 22.47 | 941.8 +/- 37.66 |
...
- Non-dominated policies: `fleetqox_predictive`, `fleetqox_csds`, `lag_adapt_003`, `lag_adapt_002`, `fleetqox_predictive_guarded`.

## Interpretation

- Highest mean utility: `fleetqox_predictive` at `8503.2`.
- Best zero-measured-miss policy: `lag_adapt_003` with utility `6899.2`.
